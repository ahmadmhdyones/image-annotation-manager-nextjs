...
export const _id = [...Array(40)].map((_, index) => `e99f09a7-dd88-49d5-b1c8-1daf80c2d7b${index + 1}`);
...
export const _ratings = [
  4.2, 3.7, 4.5, 3.5, 0.5, 3.0, 2.5, 2.8, 4.9, 3.6, 2.5, 1.7, 3.9, 2.8, 4.1, 4.5, 2.2, 3.2, 0.6, 1.3, 3.8, 3.8, 3.8,
  2.0,
];
...
export const _percents = [
  10.1, 13.6, 28.2, 42.1, 37.2, 18.5, 40.1, 94.8, 91.4, 53.0, 25.4, 62.9, 86.6, 62.4, 35.4, 17.6, 52.0, 6.8, 95.3, 26.6,
  69.9, 92.1, 46.2, 85.6,
];
...
export const _nativeM = [
  497, 763, 684, 451, 433, 463, 951, 194, 425, 435, 807, 521, 538, 839, 394, 269, 453, 821, 364, 849, 804, 776, 263,
  239,
];

export const _nativeL = [
  9911, 1947, 9124, 6984, 8488, 2034, 3364, 8401, 8996, 5271, 8478, 1139, 8061, 3035, 6733, 3952, 2405, 3127, 6843,
  4672, 6995, 6053, 5192, 9686,
];
...
export const _imageFormats = ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'webp', 'svg', 'raw', 'heif'];

export const _imageResolutions = [
  '800x600',
  '1024x768',
  '1280x720',
  '1920x1080',
...
const generateFileSize = (min: number, max: number): string => {
...
export const _fileSizes = [...Array(24)].map(
  () => generateFileSize(100, 5000) // Generates sizes between 100B and 5GB
);

export const _imagePrefix = ['IMG_', 'PHOTO_', 'DCIM_', 'DSC_', 'DSCN_', 'PICT_', 'CAPTURE_', 'SHOT_'];

export const _imageSubjects = [
  'landscape',
  'portrait',
  'family',
  'event',
...
export const _imageSuffixes = ['edit', 'final', 'raw', 'processed', 'retouched', 'print', 'web'];
